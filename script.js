...
function getUserInfo() {
    ...
    const getDataDiv = document.querySelector('.get-data');
    getDataDiv.classList.add('hide');
...
function showLocationOnMap(lat, lon, data) {
    ...
    const mapUrl = `<h2 id="postNear">Post Offices Near You</h2><iframe src="https://maps.google.com/maps?q=${lat}, ${lon}&z=15&output=embed" width="100%" height="100%"></iframe>`;
...
function showTimezone(timezone, pincode) {
    ...
    fetch(`https://api.postalpincode.in/pincode/${pincode}`)
        ...
        <h1 id="postNear">More Information About You</h1>
    ...
    fetch(`https://api.postalpincode.in/pincode/${pincode}`)
        ...
        .then((data) => {
          ...
          `;
            ...
            searchBar.innerHTML += `
        <h1 id="postNear">Post Offices Near You</h1>
          <input
            type="text"
            id="searchBox"
